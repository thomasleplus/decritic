...
compile:
	...
	GOOS=linux   GOARCH=arm   go build -o bin/decritic-linux-arm cmd/decritic/decritic.go
	GOOS=linux   GOARCH=arm64 go build -o bin/decritic-linux-arm64 cmd/decritic/decritic.go
